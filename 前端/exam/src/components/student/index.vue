    ...
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          ...
          <li><a href="javascript:;" @click="exam()" class="links">我的试卷</a></li>
          <!-- <li><a href="javascript:;" @click="practice()">我的练习</a></li> -->
          <li><router-link to="/scoreTable" class="links">我的分数</router-link></li>
          <li><router-link to="/message" class="links">给我留言</router-link></li>
...
export default {
  ...
  methods: {
    exit() {  //退出登录
      ...
      this.$cookies.remove("studentName") //清除cookie
    ...
    userInfo() {
      let studentName = this.$cookies.get("studentName")
