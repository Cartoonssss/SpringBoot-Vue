<template>
  <div class="score">
    ...
    <div class="title">
      ...
      <p class="description">(总分：{{ totalScore }}分,限时：{{ totalTime }}分钟,学生：{{ studentName }})</p>
    </div>
    <div class="total">
      <div class="look">
        本次考试成绩
...
export default {
  data() {
    return {
      ...
      imgShow: false, //图片显示
      imgSrc: {
        fail1: require("@/assets/img/cry.jpg"),
        fail2: require('@/assets/img/bad.jpg'),
        pass1: require('@/assets/img/good1.png'),
